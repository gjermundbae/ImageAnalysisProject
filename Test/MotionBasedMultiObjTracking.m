function MotionBasedMultiObjTracking()
...
% foreground objects, and displaying results.
    ...
    function obj = setupSystemObjects()
        ...
        obj.reader = VideoReader('squash_videos\simen_vid.MOV');
        %obj.reader = VideoReader('ten_sec.mp4');
        ...
        obj.blobAnalyser = vision.BlobAnalysis('BoundingBoxOutputPort', true, ...
            ...
            'MinimumBlobArea',20);%, 'MaximumBlobArea',55);
